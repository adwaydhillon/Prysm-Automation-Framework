...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TestSelection_t, stringdata) + ofs \
...
const QMetaObject TestSelection::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TestSelection.data,
      qt_meta_data_TestSelection,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestSelection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestSelection.stringdata))
        return static_cast<void*>(const_cast< TestSelection*>(this));
